...
bow = Weapon('Лук сверкающей спирали',2, 500, 3.5, 0, 0)
rapier = Weapon('Рапира "Ярость Бездны"', 3, 600, 2.7, 70, 65)
claymore = Weapon('Меч безжалостной волны', 16, 1500, 0.6, 150, 45)
sword = Weapon('Клинок "Гроза драконов"', 6, 1000, 1.2, 100, 50)
axe = Weapon('Топор раскола', 9, 1300, 0.5,)
